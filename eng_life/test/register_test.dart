...
void main() {
  ...
  Future<void> registrationTesterHelper({@required WidgetTester widgetTester, @required AuthService authService, @required Widget registerPage, String name : '', String email : '', String password : '', String password2 : ''}) async{
